  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "pattern-2":
          "linear-gradient(to right, rgba(255, 255, 255, 1.0) 10%, transparent 40%), linear-gradient(to bottom, rgba(255, 255, 255, 1.0) 20%, transparent 100%), linear-gradient(to top, rgba(255, 255, 255, 1.0) 3%, transparent 20%) ,url('/udvar1.jpg')",
      },
      screens: {
        xs: "400px",
        "3xl": "1680px",
